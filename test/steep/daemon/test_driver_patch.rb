...
module Steep
  module Daemon
    class TestDriverPatch < Minitest::Test
      ...
      def test_driver_check_has_use_daemon_method
        ...
        assert Steep::Drivers::Check.method_defined?(:use_daemon)
      end

      def test_driver_check_has_run_with_server_method
        require "steep/drivers/check"

        assert Steep::Drivers::Check.method_defined?(:run_with_server)
      end

      def test_driver_check_has_wait_for_daemon_method
        require "steep/drivers/check"

        assert Steep::Drivers::Check.method_defined?(:wait_for_daemon)
      end

      def test_driver_check_has_build_typecheck_params_method
        require "steep/drivers/check"

        assert Steep::Drivers::Check.method_defined?(:build_typecheck_params)
      end

      def test_driver_check_has_print_typecheck_result_method
        require "steep/drivers/check"

        assert Steep::Drivers::Check.method_defined?(:print_typecheck_result)
      end
